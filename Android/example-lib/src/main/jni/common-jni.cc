...
extern "C" {
  ...
  Java_example_lib_MathLib_initializeNative(JNIEnv *env, jobject instance) {
    MathLib *m = new MathLib();
    setHandle(env, instance, m);
  }

  JNIEXPORT jdouble JNICALL
  Java_example_lib_MathLib_dotProduct(JNIEnv *env, jobject instance,
  ...
  JNIEXPORT void JNICALL
  Java_example_lib_StringLib_initializeNative(JNIEnv *env, jobject instance, jstring s_) {
  ...
  Java_example_lib_StringLib_concat(JNIEnv *env, jobject instance, jstring s_) {
    const char *s = env->GetStringUTFChars(s_, 0);
  ...
  JNIEXPORT jstring JNICALL
  Java_example_lib_StringLib_getStr(JNIEnv *env, jobject instance) {
    StringLib *fs = getHandle<StringLib>(env, instance);
  ...
  Java_example_lib_StringLib_lolTest(JNIEnv *env, jobject instance) {
    StringLib *fs = getHandle<StringLib>(env, instance);
    jint result = fs->getInt();
    return result;
  }
